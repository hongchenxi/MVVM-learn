...
struct MessierDataModel {
    ...
    let updateDate: updatedDate
    let description: String
    let thumbnail: String
}


let updateDateMessier1 = updatedDate(year: 2017, month: 10, day: 19)
...
let updateDateMessier8 = updatedDate(year: 2017, month: 10, day: 19)
...
let updateDateMessier57 = updatedDate(year: 2017, month: 10, day: 19)
